...
<html>
  ...
  <body>
    ...
    <p>Given 2 URLs, one for the previous version of a file to use as a dictionary and one for the new version of a file, it will compress the new
      file with varous levels of brotli compression using the previous version as an external dictionary (brotli -D) and compare the results
      to compressing the new file with brotli alone.
    </p>
    <p>There is a version of this test for use with dynamic content (i.e. HTML) <a href="/shared-brotli/">here</a>.</p>
